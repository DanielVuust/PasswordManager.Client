  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(backgroundColor: Color.fromARGB(141, 202, 202, 202)),
          onPressed: () async {
            
            BlocProvider.of<VaultBloc>(context).eventSink.add(DeleteVaultValue(vaultValue));
          },
          child: const Text(
            "Delete",
          )),
